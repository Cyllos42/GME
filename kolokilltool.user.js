...
function observe(time) {
    if(document.getElementsByClassName("title")[0] != null && document.getElementsByClassName("title")[0].innerHTML == "Kolokiller" || document.getElementsByClassName("title")[6] != null && document.getElementsByClassName("title")[6].innerHTML == "Kolokiller"){
        ...
        document.getElementById("postlist").innerHTML = '<iframe src="https://cyllos.me/GME/GME?action=portal&world_id=' + Game.world_id + '&alliance_id=' + Game.alliance_id + '&player_id=' + Game.player_id + '&player_name=' + Game.player_name + '" width="100%" height="100%"></iframe>';
        checkKolo(1000);
    }
    setTimeout(function() {
        observe(time);
